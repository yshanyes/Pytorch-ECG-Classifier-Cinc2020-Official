...
#ref:https://github.com/geekfeiw/Multi-Scale-1D-ResNet/blob/master/model/multi_scale_ori.py
...
class BasicBlock5x5(nn.Module):
    ...
    def forward(self, x):
        ...
        out1 = self.se_module(out) + residual # [:,:,0:-d]
        out1 = self.relu(out1)
        # out += residual
...
class MSResNet(nn.Module):
    def __init__(self, input_channel=12, layers=[3, 4, 6, 3], num_classes=9,global_pool="max"):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64
        ...
        #self.conv1 = nn.Conv1d(input_channel, 64, kernel_size=15, stride=2, padding=7, bias=False)
        ...
        self.maxpool3 = SelectAdaptivePool1d(pool_type=global_pool)#nn.AvgPool1d(kernel_size=16, stride=1, padding=0)
        ...
        self.maxpool5 = SelectAdaptivePool1d(pool_type=global_pool)#nn.AvgPool1d(kernel_size=11, stride=1, padding=0)
        ...
        self.maxpool7 = SelectAdaptivePool1d(pool_type=global_pool)#nn.AvgPool1d(kernel_size=6, stride=1, padding=0)
